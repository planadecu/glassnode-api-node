...
at `https://x402.glassnode.com` (mainnet) and `a testnet x402 endpoint` (testnet). Requests that
...
- A single end-to-end test against `a testnet x402 endpoint` (Base Sepolia, `eip155:84532`) that makes
